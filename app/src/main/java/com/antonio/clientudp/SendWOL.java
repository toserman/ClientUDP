...
public class SendWOL {
    ...
    public static String send(String mac, String ip) throws IOException {
        return send(mac, ip, PORT);
    }

    public static String send(String mac, String ip, int port) throws IOException {
        ...
        Log.d(MainActivity.TAG, "Send WOL MAC : " + new String(macBytes));
        ...
        Log.d(MainActivity.TAG, "Send WOL PACKET " + address);
